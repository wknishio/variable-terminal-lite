...
//	}
  ...
  private void setMultiplexedStreams() throws IOException
  {
    ...
    // heavyImageDataInputStream =
    // VTCompressorSelector.createCompatibleSyncFlushInflaterInputStream(graphicsHeavyImageInputStream);
    //heavyImageDataInputStream = VTCompressorSelector.createBufferedZlibInputStream(graphicsHeavyImageInputStream);
    ...
    // graphicsControlInputStream.addPropagated(heavyImageDataInputStream);
