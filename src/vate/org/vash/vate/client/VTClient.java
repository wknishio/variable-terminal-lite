...
//  }
  ...
  public boolean saveClientSettingsFile(String settingsFile)
  {
  ...
  public boolean loadClientSettingsFile(String settingsFile)
  {
    loadFromConnectorToClient();
    boolean found = false;
...
//    }
  ...
  private void configure()
  {
    while ((active && (hostAddress == null || hostPort == null)) || (!active && hostPort == null))
    {
      ...
      {
        VTSystemConsole.print("VT>Press enter to start client:");
...
//      manual = true;
      ...
      try
      {
        ...
        {
          if (loadClientSettingsFile(line))
          {
            return;
          }
        }
      ...
      try
      {
        ...
        else
        {
          ...
          if (line.toUpperCase().startsWith("Y"))
          {
            VTSystemConsole.print("VT>Enter proxy type(DIRECT as D, SOCKS as S, HTTP as H, PLUS as P, default:A):");
            line = VTSystemConsole.readLine(true);
            if (line == null)
            {
              VTRuntimeExit.exit(0);
        ...
        String command = VTSystemConsole.readLine(true);
        if (command == null)
        {
          VTRuntimeExit.exit(0);
        }
...
//      }
    ...
    VTSystemConsole.print("VT>Variable-Terminal " + VT.VT_VERSION + " - Client - (c) " + VT.VT_YEAR + " wknishio@gmail.com\n" + 
