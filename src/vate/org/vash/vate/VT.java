...
public class VT
{
  ...
  public static final int VT_PACKET_DATA_SIZE_BYTES = 1024 * 4;
  ...
  public static final int VT_CHANNEL_PACKET_BUFFER_SIZE_BYTES = 1024 * 32;
  public static final int VT_STANDARD_BUFFER_SIZE_BYTES = 1024 * 32;
  public static final int VT_COMPRESSION_BUFFER_SIZE_BYTES = 1024 * 32;
  public static final int VT_FILE_BUFFER_SIZE_BYTES = 1024 * 32;
  ...
  public static final int VT_AUTHENTICATION_TIMEOUT_MILLISECONDS = 90000;
  public static final int VT_CONNECTION_DATA_TIMEOUT_MILLISECONDS = 90000;
  public static final int VT_CONNECTION_ATTEMPT_TIMEOUT_MILLISECONDS = 90000;
  ...
  public static final int VT_GRAPHICS_MODE_GRAPHICS_IMAGE_CODING_DOF = 50;
